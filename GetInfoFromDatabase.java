...
public class GetInfoFromDatabase {
	...
	public ArrayList<Task> queryAllTasks(String userID)
	{
		//output ArrayList
	...
	public ArrayList<Task> getActiveTasks(String userID)
	{
		ArrayList<Task> taskList = new ArrayList<>();
	...
	public void update(ArrayList<Tasks> taskList, String userID)
	{
